...
- выполняется корректирующий проход Модуля II;
...
Следующий практический этап: внести правки по review Модуля II и подготовить модуль к пользовательскому review.
...
- [ ] Корректирующий проход Модуля II выполнен
