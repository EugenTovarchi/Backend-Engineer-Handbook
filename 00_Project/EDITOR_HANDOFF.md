...
- Модуль III `Аутентификация и авторизация в ASP.NET Core: Cookies, JWT, OAuth 2.0 и OpenID Connect` начат:
  ...
  - главы 1–4 ожидают пользовательский review и ещё не утверждены;
  - главы 5–17 содержат только архитектурный каркас.
...
Архитектура и маршрут Модуля III утверждены пользователем. Текущий рабочий этап содержит каркас 17 глав и первый блок глав 1–4.
...
Главы 5–17 пока являются только архитектурным каркасом. Их нельзя считать написанными и нельзя наполнять без отдельного задания.

Следующий этап: пользовательский review исправленных глав 1–4 в рабочем чате. Главы 5–17 не писать до отдельного задания. Модуль II не менять без отдельного запроса.
...
8. Не писать главы 5–17 Модуля III до отдельного задания.
