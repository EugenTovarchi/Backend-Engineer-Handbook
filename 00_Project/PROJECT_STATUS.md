...
Следующий практический этап: написать восемь глав Модуля II `ASP.NET Core Request Pipeline`.
...
**Статус:** структура утверждена, главы ещё не созданы.
...
1. Создать восемь глав Модуля II.
2. Провести техническую и Markdown-проверку нового модуля.
3. Передать Модуль II на редакторскую проверку в рабочем чате.
4. Не считать Модуль II завершённым до пользовательского review и финального редакторского прохода.
