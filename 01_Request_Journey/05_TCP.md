...
**Прогресс до главы:** 44% (4 из 9 глав завершены)
...
- [WebSocket](../02_Entry_Layer/08_WebSocket_Polling_Long_Polling.md)
...
Если второе соединение не установится, пользователь может увидеть ошибку обратного прокси, например `502 Bad Gateway`.
...
Если `directory-service` не запущен, слушает другой порт или для имени сервиса не найден IP-адрес, Nginx не сможет установить TCP-соединение к backend.
...
**Модуль I:** `Путешествие одного запроса`  
**Прогресс после главы:** 56% (5 из 9 глав завершены).
