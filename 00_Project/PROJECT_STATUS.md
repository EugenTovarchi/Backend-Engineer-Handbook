...
Текущий активный модуль: `Модуль III. Аутентификация и авторизация`.
...
Следующий практический этап: утверждение окончательной архитектуры и маршрута Модуля III.
...
1. Утвердить окончательную архитектуру и маршрут Модуля III.
2. После утверждения маршрута начать работу над главами Модуля III.
