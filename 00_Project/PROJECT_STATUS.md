...
- главы 5–17 Модуля III содержат только архитектурный каркас и не считаются написанными;
- пользовательский review глав 1–4 ещё не выполнен;
- главы 1–4 Модуля III ещё не утверждены пользователем;
- scope ASP.NET Core Web API восстановлен как будущий Модуль V.

Следующий практический этап: пользовательский review исправленного первого блока глав 1–4 Модуля III.
...
1. Провести пользовательский review исправленных глав 1–4 Модуля III.
2. После approval первого блока отдельно переходить к следующим главам Модуля III.
...
- [ ] Пользовательский review глав 1–4 Модуля III выполнен
- [ ] Главы 1–4 Модуля III утверждены пользователем
- [ ] Главы 5–17 Модуля III написаны полностью
